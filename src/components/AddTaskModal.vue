<template>
    <v-dialog persistent scrollable v-model="dialog" max-width="90%">
        ...
        <v-card>
            ...
            <v-card-text>
                <v-row>
                    <v-col cols="6" sm="6">
                        <v-select label="Client" :items="clients" outlined hide-details v-model="selectedClient">
                    ...
                    <v-col cols="6" sm="6">
                        <v-select label="Project" :items="projects" outlined hide-details v-model="selectedProject">
                            <template v-slot:append-outer>
                                Project
                            </template>
                        </v-select>
        ...
        watch: {
            dialog() {
                ...
                if(this.dialog == true) {
                    ...
                    this.selectedProject = this.sel_proj
