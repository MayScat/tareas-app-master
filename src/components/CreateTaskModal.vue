                    ...
                    <v-col cols="6" sm="6">
                        <v-autocomplete
                            ...
                            <template v-slot:append-outer>
                                <add-client :dpd="true"></add-client>
                            </template>
                            </v-autocomplete>
                    </v-col>
                    <v-col cols="6" sm="6">
                        <v-autocomplete
                            ...
                            >
                            <template v-slot:append-outer>
                               <add-project :dpd="true"></add-project>
                            </template>
                        </v-autocomplete>
                    </v-col>
                    <v-col cols="6">
...
<script>
    import AddClient from '@/components/CreateClientModal.vue'
    import AddProject from '@/components/CreateProjectModal.vue'
    export default {
        components: {
            AddClient,
            AddProject
        ...
        mounted() {
            ...
            Events.$on('reload-client', (data) => {
                this.getClients
            })

            Events.$on('reload-project', (data) => {
                this.getProjects
            })
